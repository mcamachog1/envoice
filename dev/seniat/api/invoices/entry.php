...
// app/api/invoices/entry.php
    ...
    $parmsob = array("invoiceid","sessionid","customerid");
    ...
    validSession($db, $_REQUEST["sessionid"],array('ip'=>$_SERVER['REMOTE_ADDR'],'app'=>'SENIAT','module'=>'invoices','dsc'=>'Consultar factura.'));    
