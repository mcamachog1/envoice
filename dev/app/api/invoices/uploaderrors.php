<?php
// app/api/invoices/uploaderrors.php
...
// Parametros obligatorios
  $parmsob = array("sessionid","errorcode","order","offset","numofrec");
...
// Obtener registros del error indicado
  $sql = "SELECT * FROM loadinvoiceheader LIMIT 1";
  if (!$rs = $db->query($sql))
