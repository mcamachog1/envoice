...
var WS_wstimeout;
/*function callWS(type, service, params, response, ref=null){
    //var url = "http://totalsoftware.com.ve/~veneden/dev/api/";
    var url = globalurl + "/api/";
    switch (type){
        case "GET":
            ...
            request.open('GET', url + service + "?" + parsedPars);
            ...
            request.onreadystatechange = function () {
                if (this.readyState === 4) {
                    //if (WS_waitscreen){
                        ...
                        //waitScreen.parentElement.removeChild(waitScreen);
