...
// cms/api/customers/list.php
    ...
    $userid = isSessionValidCMS($db, $_REQUEST["sessionid"],array('ip'=>$_SERVER['REMOTE_ADDR'],'app'=>'CMS','module'=>'customers','dsc'=>'list.php'));
    ...
    while ($row = $rs->fetch_assoc()){
        ...
        /*
            $record->seniat->serie=$row["serie"];
            $record->seniat->control= new stdClass;
                $record->seniat->control->initial=str_pad($row["initialcontrol"],8,"0",STR_PAD_LEFT);
                $record->seniat->control->next=$row["nextcontrol"];
        */
        $record->image="";        
        // Image
